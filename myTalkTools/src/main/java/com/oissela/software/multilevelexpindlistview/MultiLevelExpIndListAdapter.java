...
/**
 * Multi-level expandable indentable list ContactAdapter.
...
public abstract class MultiLevelExpIndListAdapter extends RecyclerView.Adapter {
     ...
     * @return true if this ContactAdapter was modified by this operation, false otherwise.
     */
    ...
    public void expandGroup(int position) {
        ...
        //addAll(position + 1, firstItem.getChildren());
        addAll(position + 1, group == null ? firstItem.getChildren() : group);
    }
