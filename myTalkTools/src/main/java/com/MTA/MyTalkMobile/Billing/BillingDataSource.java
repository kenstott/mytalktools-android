package com.MTA.MyTalkMobile.Billing;
 ...
 */
public class BillingDataSource implements PurchasesUpdatedListener,
        BillingClientStateListener, SkuDetailsResponseListener {
    private static final String TAG = "MyTalkMobile:" + BillingDataSource.class.getSimpleName();
    ...
    final public Map<String, MutableLiveData<SkuState>> skuStateMap = new HashMap<>();
    final public MutableLiveData<Boolean> initialized = new MutableLiveData<>();
     ...
     * returned until the purchase is acknowledged. * <p> <a href="https://developer.android">...</a>
                        ...
                        if (knownAutoConsumeSKUs.contains(sku)) {
                            ...
                            if (isConsumable) {
                                Log.e(TAG, "Purchase cannot contain a mixture of consumable" +
                                        "and non-consumable items: " + purchase.getSkus());
                                isConsumable = false;
                                break;
                            }
                        }
